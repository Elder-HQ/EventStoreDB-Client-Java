...
public class EventStoreDBClient extends EventStoreDBClientBase {
    ...
    public Publisher<ResolvedEventWithContext> readStreamReactiveWithContext(String streamName, long maxCount, ReadStreamOptions options) {
        if (options == null)
    ...
    public Publisher<ResolvedEvent> readStreamReactive(String streamName, long maxCount, ReadStreamOptions options) {
        final Publisher<ResolvedEventWithContext> parent = readStreamReactiveWithContext(streamName, maxCount, options);

        return publisherMap(parent, ResolvedEventWithContext::getEvent);
    }
    ...
    public Publisher<ResolvedEventWithContext> readAllReactiveWithContext(long maxCount, ReadAllOptions options) {
        if (options == null)
    ...
    public Publisher<ResolvedEvent> readAllReactive(long maxCount, ReadAllOptions options) {
        Publisher<ResolvedEventWithContext> parent = new ReadAll(this.client, maxCount, options);
